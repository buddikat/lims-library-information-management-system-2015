...
<body>
    ...
    <?php
        ...
        if (isset($_POST['btnBookSave']))
        {
            ...
            {
                $_SESSION['ses_infoMsg'] = "The given book reference number is already exist.";
            }
            else
            {
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<!-- Main bar -->
	    ...
	    <div class="page-head">
        <!-- Page heading -->
	      <h2 class="pull-left">Edit Books 
          <!-- page meta -->
          <span class="page-meta">Edit your book information</span>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="invBooks.php" class="bread-crumb">Books</a>
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Edit Books</a>
        </div>
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                      ...
                      <form class="form-horizontal" action="invEditBook.php" method="post">
                          <div class="row-fluid">
                              <div class="span6">
                                  <div class="control-group">
                                    <label class="control-label" for="inputReferenceNo">Reference #</label>
                                    <div class="controls">
                                        <input type="hidden" id="inputHiddenBookId" name="inputHiddenBookId" value="<?php echo trim($_GET['id']); ?>">
                                        <input type="text" id="inputReferenceNo" name="inputReferenceNo" placeholder="Reference No" value="<?php echo trim($_GET['referenceNo']); ?>">
                                    </div>
                                  </div>
                        <div class="control-group">
                            <label class="control-label" for="inputBookNameEn">Book Title</label>
                            <div class="controls">
                                <input type="text" id="inputBookNameEn" name="inputBookNameEn" placeholder="Book Title" value="<?php echo trim($_GET['bookTitle']); ?>">
                            </div>
                        </div>
                                  <hr>
                                  <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="inputAuthorName" name="inputAuthorName" placeholder="Author Name" value="<?php echo trim($_GET['authorName']); ?>">
                            </div>
                        </div>
                                  <div class="control-group">
                            <label class="control-label" for="inputBookPrice">Book Price</label>
                            <div class="controls">
                                <input type="text" id="inputBookPrice" name="inputBookPrice" placeholder="Price" value="<?php echo trim($_GET['price']); ?>">
                            </div>
                        </div>
                                  <div class="control-group">
                            <label class="control-label" for="inputBookPages">Pages</label>
                            <div class="controls">
                                <input type="text" id="inputBookPages" name="inputBookPages" placeholder="Pages" value="<?php echo trim($_GET['pages']); ?>">
                            </div>
                        </div>
                              </div>
                              ...
                              <div class="span6">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="bookCategoryNo" name="bookCategoryNo" placeholder="Category No" value="<?php echo trim($_GET['categoryId']); ?>">
                                    </div>
                                  </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="inputBookType">
                                    <?php
                                        if(trim($_GET['bookType']=="LENDING"))
                                        {
                                            echo '<option value="Lending" selected>Lending</option>';
                                            echo '<option value="Reference">Reference</option>';
                                        }
                                        else if (trim($_GET['bookType']=="REFERENCE"))
                                        {
                                            echo '<option value="Lending">Lending</option>';
                            ...
                            <div class="controls">
                                <input type="text" id="inputPublisherName" name="inputPublisherName" placeholder="Publisher Name" value="<?php echo trim($_GET['publisherName']); ?>">
                            </div>
                        </div>
                                  <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="inputPublishedYear">
                                    <?php
                                        ...
                                        for($i = 1; $i <=20; $i++)
                                        {
                                            if ($currentYear == trim($_GET['publishedYear']))
                                            {
                            ...
                            <div class="controls">
                                <select name="inputSupplyMode">
                                    <?php
                                        if (trim($_GET['suppliedMode']) == "Purchases")
                                        {
                                            echo '<option value="Purchases" selected>Purchases</option>';
                                            echo '<option value="Ministry of Education">Ministry of Education</option>';
                                            echo '<option value="Donation">Donation</option>';
                                            echo '<option value="Replacement">Replacement</option>';
                                        }
                                        else if (trim($_GET['suppliedMode']) == "Ministry of Education")
                                        {
                                            echo '<option value="Purchases">Purchases</option>';
                                            echo '<option value="Ministry of Education" selected>Ministry of Education</option>';
                                            echo '<option value="Donation">Donation</option>';
                                            echo '<option value="Replacement">Replacement</option>';
                                        }
                                        else if (trim($_GET['suppliedMode']) == "Donation")
                                        {
                                            echo '<option value="Purchases">Purchases</option>';
                                            echo '<option value="Ministry of Education">Ministry of Education</option>';
                                            echo '<option value="Donation" selected>Donation</option>';
                                            echo '<option value="Replacement">Replacement</option>';
                                        }
                                        else if (trim($_GET['suppliedMode']) == "Replacement")
                                        {
                                            echo '<option value="Purchases">Purchases</option>';
                                            echo '<option value="Ministry of Education">Ministry of Education</option>';
                                            echo '<option value="Donation">Donation</option>';
                                            echo '<option value="Replacement" selected>Replacement</option>';
                                        }
