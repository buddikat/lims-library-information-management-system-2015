...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    ...
	    <div class="page-head">
        <!-- Page heading -->
	      <h2 class="pull-left">Damaged Books 
          <!-- page meta -->
          <span class="page-meta">List of the damaged book information</span>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="invDamagedBooks.php" class="bread-current">Damaged Books</a>
        </div>
          ...
          <div class="row-fluid">
              <div class="span12">
                  <div class="pull-right">
                    <a href="invNewBook.php" class="btn btn-success">Add Book</a>
                    ...
                    <table class="table table-bordered ">
                      ...
                      <tbody>
                          ...
                          <?php
                            ...
                            $sql_getAllBooks = "SELECT * FROM lims_2015.inv_books where record_status='ACTIVE'";
