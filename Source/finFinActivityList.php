...
<head>
  ...
  <title>Finance - Library Information Management System</title>
...
<body>
    ...
    <?php
        ...
        {
            $publicationName = $_POST['inputPublicationName'];
            $publicationType = $_POST['rgroupPublicationType'];
            $publicationFrequency = $_POST['rgroupFrequency'];
            $publicationPrice = $_POST['inputPublicationPrice'];
...
<div class="content">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="navi">
            ...
            <li class="has_submenu nyellow current open">
              <a href="#">
                <i class="icon-file-alt"></i> Finance
                <span class="pull-right"><i class="icon-angle-right"></i></span>
              </a>

              <ul>
                  <li><a href="finManageMembers.php">Membership</a></li>
                  <li><a href="finFinActivityList.php">Activity List</a></li>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    ...
	    <div class="page-head">
        <!-- Page heading -->
	      <h2 class="pull-left">Library Membership Management 
          <!-- page meta -->
          <span class="page-meta">Library Membership Management</span>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="finManageMembers.php" class="bread-crumb">Membership</a>
        </div>
        ...
        <div class="container-fluid">
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                      ...
                      <form class="form-horizontal" id="frmBookReference" method="post" action="#">
                          <div class="row-fluid">
                              <div class="span12">
                                  <div class="control-group">
                                    <label class="control-label" for="inputBookReferenceID">Class</label>
                                    <div class="controls">
                                        <input type="text" id="inputBookReferenceID" name="inputBookReferenceID" placeholder="Reference ID">
                                    </div>
                                  </div>
                            <button type="submit" id="btnPublicationSave" name="btnProceedBook" class="btn btn-success">Proceed</button>
          ...
          <div class="row-fluid">
            <div class="widget wgreen">
                ...
                <div class="widget-head">
                  <div class="pull-left">Membership Fee</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="icon-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="icon-remove"></i></a>
                  </div>
                    ...
                    <table class="table  table-bordered ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><span class="label label-important">Not Registered</span></td>
                          <td>
