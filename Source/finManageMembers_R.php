...
<head>
  ...
  <script>
    function showMembers(str) {
      ...
      xmlhttp.open("GET","finManageMembers_S.php?class="+str,true);
      xmlhttp.send();
    }
</script>
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
            ...
            <?php
            if ($_SESSION['ses_UserRole'] == 1 or $_SESSION['ses_UserRole'] == 4)
            {
        ?>
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                      ...
                      <form class="form-horizontal" id="frmBookReference">
                          <div class="row-fluid">
                              <div class="span12">
                                  <div class="control-group">
                                    <label class="control-label" for="inputBookReferenceID">Class</label>
                                    <div class="controls">
                                        <select name="inputClasses" onchange="showMembers(this.value)">
        ...
        <div class="bread-crumb pull-right">
          ...
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Finance</a>
        </div>
