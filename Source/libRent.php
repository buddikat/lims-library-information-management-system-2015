...
<body>
    ...
    <?php
        ...
        if (isset($_POST['btnAddRent']))
        {
            ...
            {
                $bookReferenceID = trim($_POST['inputBookReferenceID']);
                $lendMemberId = trim($_POST['inputMemberID']);
                
                $sql_getMemberInfo = "call prc_get_library_member_info($lendMemberId);";
                $memberInfoRs = executeSqlQuery($sql_getMemberInfo);
                
                if (mysqli_num_rows($memberInfoRs) > 0)
                {
                    header('Location: libRentMember.php?bookRefId='.$bookReferenceID.'&MemberID='.$lendMemberId);
                    exit();
                }
                else
                {
                    $_SESSION['ses_ErrorMessage'] = "Incorrect member ID.";
                    header('Location: libRent.php?bookRefId='.$bookReferenceID);
                    exit();
                }
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                      ...
                      <?php
                            if (isset($_SESSION['ses_ErrorMessage']))
                            {
                                echo '<div class="alert alert-error">'.$_SESSION['ses_ErrorMessage'].'</div>';
                                unset($_SESSION['ses_ErrorMessage']);
                            }
                      ?>
                    
                      <form class="form-horizontal" id="frmRentBookMemberInput" method="post" action="libRent.php">
                          <div class="row-fluid">
                              <div class="span12">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <!--<input type="text" id="inputBookReferenceID" name="inputBookReferenceID" placeholder="Reference ID" value="<?php echo $noOfBookRecords; ?>"> -->
                                    </div>
                                  </div>
                                  <div class="control-group">
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="inputMemberID" name="inputMemberID" placeholder="Member ID" required>
                                    </div>
                                  </div>
                                  <a href="libHome.php"><button type="button" id="btnBackToLast" name="btnBackToLast" class="btn btn-inverse">Back</button></a>
                            <button type="submit" id="btnAddRent" name="btnAddRent" class="btn btn-success">Lend</button>
