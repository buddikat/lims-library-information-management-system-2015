                              ...
                              <div class="span12">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <label class="control-label" for="inputBookReferenceID"><?php echo $noOfBookRecords; ?></label>
                                        <?php echo $bookReferenceID . $bookTitleEn . $bookTitleSi . $bookAuthorName; ?>
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="inputMemberID">Member #</label>
                                    <div class="controls">
                                        <input type="text" id="inputMemberID" name="inputMemberID" placeholder="Member ID">
                                    </div>
                                  </div>
                            <button type="submit" id="btnPublicationSave" name="btnAddRent" class="btn btn-success">Lend</button>
