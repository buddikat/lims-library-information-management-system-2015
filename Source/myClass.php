...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="navi">
            ...
            <?php
                if (($_SESSION['ses_ClassAllocation'] != NULL)||($_SESSION['ses_ClassAllocation'] != ''))
                {
            ?>
            
            <li class="nyellow current"><a href="myClass.php"><i class="icon-dashboard"></i> Class</a></li>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    ...
	    <div class="page-head">
        <!-- Page heading -->
	      <h2 class="pull-left">My Class Dashboard - <?php echo $_SESSION['ses_ClassAllocation']; ?>
          <!-- page meta -->
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="myClass.php" class="bread-current">Class</a>
        </div>
          ...
          <div class="row-fluid">
              <div class="span6">
                ...
                <li class="bgreen">
                  ...
                  <!-- Text -->
                  <div class="datas-text pull-right"><span class="bold">5</span> Rentals</div>
                  ...
                  <div class="pull-left"><a href=""><i class="icon-book"></i></a></div>
                  <!-- Text -->
                  <div class="datas-text pull-right"><span class="bold">2</span> Attention</div>
                ...
                <li class="bred">
                  ...
                  <div class="pull-left"><a href=""><i class="icon-book"></i></a></div>
                  <!-- Text -->
                  <div class="datas-text pull-right"><span class="bold">1</span> Overdue</div>
            ...
            <div class="widget wgreen">
                ...
                <div class="widget-head">
                  <div class="pull-left">Latest Borrowings</div>
              ...
              <div class="span6">
                ...
                <li class="bgreen">
                  ...
                  <!-- Text -->
                  <div class="datas-text pull-right"><span class="bold">15</span> Done</div>
                ...
                <li class="bred">
                  ...
                  <div class="pull-left"><a href=""><i class="icon-group"></i></a></div>
                  <!-- Text -->
                  <div class="datas-text pull-right"><span class="bold">4</span> Due</div>
