...
//        }
        ...
        {
            $publicationId = trim($_POST['inputHiddenPublicationId']);
            ...
            $edited_user = trim($_SESSION['ses_UserRole']);
            
            $checkPublicationExist = "select publication_name from inv_publications where publication_name = '".$publicationName."' and publication_id <> $publicationId and record_status = 'ACTIVE'";
            ...
            {
                $addPublicationQuery = "call prc_edit_publication($publicationId, '" . $publicationName . "', '" . $publicationFrequency . "', $publicationPrice, '" . $publicationType . "', $edited_user)";
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <!-- Page heading -->
          ...
          <!-- page meta -->
          <span class="page-meta">Edit publication</span>
        </h2>
        ...
        <!-- Divider -->
          <span class="divider">/</span> 
          <a href="invEditPublications.php" class="bread-current">Edit Publications</a>
        </div>
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                      ...
                      <form class="form-horizontal" id="frmNewPublication" method="post" action="invEditPublications.php">
                          <div class="row-fluid">
                              <div class="span12">
                                  <div class="control-group">
                                    <label class="control-label" for="inputPublicationName">Publication Name</label>
                                    <div class="controls">
                                        <input type="hidden" id="inputHiddenPublicationId" name="inputHiddenPublicationId" value="<?php echo trim($_GET['id']); ?>">
                                        <input type="text" id="inputPublicationName" name="inputPublicationName" value="<?php echo trim($_GET['pubName']); ?>" placeholder="Publication Name">
                                    </div>
                                  </div>
                        <div class="control-group">
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php
                                            if (trim($_GET['pubType'])== "News Paper")
                                            {
                                                ?>
                                        <label><input name="rgroupPublicationType" type="radio" checked="true" value="News Paper" />News Paper</label>
                                        <label><input name="rgroupPublicationType" type="radio" value="Magazine" />Magazine</label>
                                        <?php
                                            }
                                        else if (trim($_GET['pubType'])== "Magazine")
                                        {
                                            ?>
                                        <label><input name="rgroupPublicationType" type="radio" value="News Paper" />News Paper</label>
                                        <label><input name="rgroupPublicationType" type="radio" checked="true" value="Magazine" />Magazine</label>
                            ...
                            <div class="controls">
                                <?php
                                            if (trim($_GET['pubFrq'])== "Daily")
                                            {
                                                ?>
                                <label><input name='rgroupFrequency' type='radio' checked="true" value='Daily' />Daily</label>
                                        ...
                                        else if (trim($_GET['pubFrq'])== "Weekly")
                                        {
                                            ?>
                                        <label><input name='rgroupFrequency' type='radio' value='Daily' />Daily</label>
                                        <label><input name='rgroupFrequency' type='radio' checked="true" value='Weekly' />Weekly</label>
                                        <label><input name='rgroupFrequency' type='radio' value='Monthly' />Monthly</label>
                                        <?php
                                            }
                                        else if (trim($_GET['pubFrq'])== "Monthly")
                                        {
                                            ?>
                                        <label><input name='rgroupFrequency' type='radio' value='Daily' />Daily</label>
                                        <label><input name='rgroupFrequency' type='radio' value='Weekly' />Weekly</label>
                                        <label><input name='rgroupFrequency' type='radio' checked="true" value='Monthly' />Monthly</label>
                                        <?php
                                            }
                                            ?>
                            </div>
                            ...
                            <div class="controls">
                                <input type="text" id="inputPublicationPrice" name="inputPublicationPrice" value="<?php echo trim($_GET['pubPri']); ?>" placeholder="0.00">
                            </div>
                        </div>
                              </div>
