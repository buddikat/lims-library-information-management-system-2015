          ...
          <ul class="navi">
            ...
            <li class="has_submenu nyellow current open">
              ...
              <ul>
                  ...
                  <li><a href="libPurchaseNewsPaper.php">Publications</a></li>
              </ul>
            </li>
    ...
    <!-- Sidebar ends -->
  	...
  	<!-- Main bar -->
        ...
        <!-- Page heading -->
          ...
          <!-- page meta -->
          <span class="page-meta">Purchasing of Publications</span>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="libPurchaseNewsPaper.php" class="bread-current">Publication Purchasing</a>
        </div>
                    ...
                    <table class="table  table-bordered ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo '<strong>'.$dt_row['publication_name'].'</strong></br>' . $dt_row['publication_type']; ?></td>
